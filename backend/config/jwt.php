...
return [
    ...
    |
    | Note: This will be used for Symmetric algorithms only (HMAC SHA256)
    |
    */
    ...
    */
    ...
    | valid for. Defaults to 30 days (43200 minutes).
    |
    */
    ...
    */
    ...
    | e.g. if you only have one authentication model, then you would set
    | this to `false`.
    |
    */
